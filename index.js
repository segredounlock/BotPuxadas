...
const NomeDoBot = "𝑺𝑬𝑮𝑹𝑬𝑫𝑶 𝑷𝑼𝑿𝑨𝑫𝑨𝑺";
...
async function verificarMensagem(sock, from, msg, body, isGroup, BOT_PHONE) {
  ...
  if (perms.isBotAdmin) {
    try {
      // ⚠️ Certifique-se de enviar **array de JIDs válidos** para remover
      await sock.groupParticipantsUpdate(from, [participant], "remove");
      console.log(`[ANTI-LINK] Usuário ${participant} removido do grupo ${perms.groupName}`);
...
function logActivity(type, details = {}) {
  ...
  switch (type) {
    case 'MESSAGE_RECEIVED':
      console.log(`📨 [${timestamp}] Mensagem recebida`, details);
      break;
    case 'COMMAND_EXECUTED':
      console.log(`⚡ [${timestamp}] Comando executado`, details);
      break;
    case 'ANTILINK_TRIGGERED':
      console.log(`🚫 [${timestamp}] Anti-link ativado`, details);
      break;
    case 'CONFIG_CHANGED':
      console.log(`⚙️ [${timestamp}] Configuração alterada`, details);
      break;
    default:
...
async function handleWelcome(sock, events) {
  ...
  if (events["group-participants"]?.update) {
    ...
    if (action === "add") {
      ...
      // 🔹 Verifica cooldown do grupo
      const now = Date.now();
      if (welcomeCooldowns[id] && now - welcomeCooldowns[id] < 40000) {
        // Se ainda estiver no cooldown de 40s, não envia nada
        return;
      }
      // Atualiza o cooldown
      ...
      // 🔹 Array de mensagens de boas-vindas aleatórias
      const welcomeMessages = [
      "𝑺𝒆𝒋𝒂 𝒎𝒖𝒊𝒕𝒐 𝑩𝒆𝒎 𝑽𝒊𝒏𝒅𝒐(𝒂), 𝒒𝒖𝒆 𝒔𝒖𝒂 𝒆𝒔𝒕𝒂𝒅𝒊𝒂 𝒔𝒆𝒋𝒂 𝒊𝒏𝒄𝒓𝒊𝒗𝒆𝒍! 🌟",
      "👋 𝑶𝒍𝒂́! 𝒑𝒓𝒆𝒑𝒂𝒓𝒆-𝒔𝒆 𝒑𝒂𝒓𝒂 𝒐𝒔 𝒎𝒐𝒎𝒆𝒏𝒕𝒐𝒔 𝒅𝒊𝒗𝒆𝒓𝒕𝒊𝒅𝒐𝒔 𝒄𝒐𝒎 𝒂 𝒈𝒂𝒍𝒆𝒓𝒂!",
      "🎉 𝑪𝒉𝒆𝒈𝒐𝒖 𝒎𝒂𝒊𝒔 𝒖𝒎 𝒎𝒆𝒎𝒃𝒓𝒐! 𝒒𝒖𝒆 𝒄𝒐𝒎𝒆𝒄𝒆 𝒂 𝒅𝒊𝒗𝒆𝒓𝒔𝒂𝒐!",
      "✨ 𝑩𝒆𝒎 𝒗𝒊𝒏𝒅𝒐(𝒂)! 𝑬𝒔𝒑𝒆𝒓𝒂𝒎𝒐𝒔 𝒒𝒖𝒆 𝒗𝒄 𝒄𝒖𝒓𝒕𝒂 𝒄𝒂𝒅𝒂 𝒎𝒐𝒎𝒆𝒏𝒕𝒐 𝒂𝒒𝒖𝒊!",
      "🤗 𝑭𝒊𝒒𝒖𝒆 𝒂 𝒗𝒐𝒏𝒕𝒂𝒅𝒆! 𝒇𝒂𝒄𝒂 𝒂𝒎𝒊𝒈𝒐𝒔 𝒆 𝒂𝒑𝒓𝒐𝒗𝒆𝒊𝒕𝒆 𝒐 𝒈𝒓𝒖𝒑𝒐!",
      "🔎 𝑪𝒐𝒏𝒉𝒆𝒄𝒂 𝒐 𝒎𝒆𝒍𝒉𝒐𝒓 𝒃𝒐𝒕 𝒅𝒆 𝒑𝒖𝒙𝒂𝒅𝒂𝒔 𝒅𝒐 𝒘𝒉𝒂𝒕𝒔𝒂𝒑𝒑!",
      ];
      ...
      for (const participant of participants) {
        ...
        const welcomeMsg = `༺⋆☽˚☪ *BEM-VINDO(A)* ☪˚☽˚༻

☣️ *${metadata.subject}* ☣️

✨ Olá *${userName}* (@${participant.split("@")[0]})!
...
case 'cpf1': {
    ...
    if (!cpf || cpf.length !== 11) {
        return sock.sendMessage(from, {
            text: `❌ Informe um CPF válido.\n📌 Exemplo: ${config.prefix}cpf51 12345678900`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando CPF ${cpf}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o CPF informado.`
            ...
            if (typeof obj === 'object') {
                return Object.entries(obj)
                    .map(([k, v]) => {
                        ...
                        return `🔎 *${chave}:* *${valorLimpo || 'SEM INFORMAÇÃO'}*`;
                    })
                    .filter(Boolean)
                    .join('\n');
            }
...
${formatarBlocos(data.data)}
        ...
        const fs = require('fs');
        const path = `/tmp/consulta_cpf_${cpf}.txt`; // caminho temporário
        ...
        await sock.sendMessage(from, {
            document: { url: path },
            mimetype: 'text/plain',
            fileName: `consulta_cpf_${cpf}.txt`
        }, { quoted: msg, edit: carregando.key });

        // Opcional: deletar arquivo temporário depois
        fs.unlinkSync(path);
...
case 'cns': {
    const cns = args[0]?.replace(/\D/g, '').trim();

    if (!cns || cns.length !== 15) {
        return sock.sendMessage(from, {
            text: `❌ Informe um CNS válido (15 dígitos).\n📌 Exemplo: ${config.prefix}cns 123456789123456`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🩺 *Consultando CNS "${cns}"... Aguarde!*`
        }, { quoted: msg });

        // 🔗 Consulta API (substitua pela URL real)
        const response = await fetch(
            `http://nxf-2.nexfuture.com.br:25589/cns?cns=${encodeURIComponent(cns)}`
        );
        const data = await response.json();

        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o CNS informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'cnpj': {
    ...
    if (!cnpj || cnpj.length !== 14) {
        return sock.sendMessage(from, {
            text: `❌ Informe um CNPJ válido.\n📌 Exemplo: ${config.prefix}cnpj 12345678000195`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando CNPJ ${cnpj}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o CNPJ informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'funcionarios': {
    ...
    if (!codigo) {
        return sock.sendMessage(from, {
            text: `❌ Informe o código ou matrícula do funcionário.\n📌 Exemplo: ${config.prefix}funcionarios 12345`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando funcionário ${codigo}... Aguarde!*`
        }, { quoted: msg });

        // 🔗 Consulta API (troque a URL pela real)
        const response = await fetch(
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o código informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
╰━━━━━━━━━━━━━━⬣
        ...
        await sock.sendMessage(
            from,
            { text: '❌ Erro ao consultar funcionário.' },
            { quoted: msg }
        );
    }
...
case 'socios': {
    ...
    if (!cnpj || cnpj.length !== 14) {
        return sock.sendMessage(from, {
            text: `❌ Informe um CNPJ válido para consultar sócios.\n📌 Exemplo: ${config.prefix}socios 12345678000195`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando sócios do CNPJ ${cnpj}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data || !data.data.length) {
            return sock.sendMessage(from, {
                text: `❌ Nenhum sócio encontrado para o CNPJ informado.`
            }, { quoted: msg, edit: carregando.key });
        }
        ...
        const formatarBlocos = (obj, nivel = 0) => {
            ...
            if (Array.isArray(obj)) {
                return obj
                    .map(i => formatarBlocos(i, nivel + 1))
                    .filter(Boolean)
                    .join('\n\n'); // separa sócios com espaço extra
            }
...
case 'email': {
    ...
    if (!email) {
        return sock.sendMessage(from, {
            text: `❌ Informe um email válido.\n📌 Exemplo: ${config.prefix}email teste@dominio.com`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando email ${email}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o email informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'nome': {
    ...
    if (!nome) {
        return sock.sendMessage(from, {
            text: `❌ Informe um nome válido.\n📌 Exemplo: ${config.prefix}nome Italo Costa`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando nome "${nome}"... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data || !data.data.length) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o nome informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case "abreviado": {
    ...
    if (!nome) {
        return sock.sendMessage(from, {
            text: `❌ Informe o nome para consulta abreviada.\n📌 Exemplo: ${config.prefix}abreviado Italo Costa`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando nome abreviado: ${nome}... Aguarde!* 🔎`
        }, { quoted: msg });
...
╰━━━━━━━━━━━━━━⬣
        ...
        await sock.sendMessage(
            from,
            { text: '❌ Erro ao consultar nome abreviado.' },
            { quoted: msg }
        );
    }
...
case 'tel': {
    ...
    if (!telefone || telefone.length < 10) {
        return sock.sendMessage(from, {
            text: `❌ Informe um número de telefone válido.\n📌 Exemplo: ${config.prefix}telefone 11987654321`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando telefone ${telefone}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o telefone informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'rg': {
    ...
    if (!rg || rg.length < 5) {
        return sock.sendMessage(from, {
            text: `❌ Informe um RG válido.\n📌 Exemplo: ${config.prefix}rg 123456789`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando RG ${rg}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o RG informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'cnh': {
    ...
    if (!cnh || cnh.length < 10) {
        return sock.sendMessage(from, {
            text: `❌ Informe uma CNH válida.\n📌 Exemplo: ${config.prefix}cnh 12345678901`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando CNH ${cnh}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para a CNH informada.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'obito': {
    ...
    if (!query) {
        return sock.sendMessage(from, {
            text: `❌ Informe o nome ou CPF para consulta de óbito.\n📌 Exemplo: ${config.prefix}obito Italo Costa`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando óbito para "${query}"... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data || !data.data.length) {
            return sock.sendMessage(from, {
                text: `❌ Nenhum registro de óbito encontrado para a consulta informada.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'nis': {
    ...
    if (!nis || nis.length < 10) {
        return sock.sendMessage(from, {
            text: `❌ Informe um NIS válido.\n📌 Exemplo: ${config.prefix}nis 12345678901`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando NIS ${nis}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o NIS informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'pis': {
    ...
    if (!pis || pis.length < 10) {
        return sock.sendMessage(from, {
            text: `❌ Informe um número PIS válido.\n📌 Exemplo: ${config.prefix}pis 12345678901`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando PIS ${pis}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o PIS informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'vacinas': {
    ...
    if (!cpf || cpf.length !== 11) {
        return sock.sendMessage(from, {
            text: `❌ Informe um CPF válido.\n📌 Exemplo: ${config.prefix}vacinas 12345678900`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `💉 *Consultando vacinas para CPF ${cpf}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação de vacinas encontrada para o CPF informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
╰━━━━━━━━━━━━━━⬣
        ...
        await sock.sendMessage(
            from,
            { text: '❌ Erro ao consultar vacinas.' },
            { quoted: msg }
        );
    }
...
case 'renavam': {
    ...
    if (!renavam || renavam.length < 9) {
        return sock.sendMessage(from, {
            text: `❌ Informe um RENAVAM válido.\n📌 Exemplo: ${config.prefix}renavam 12345678901`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🚗 *Consultando RENAVAM ${renavam}... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o RENAVAM informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
╰━━━━━━━━━━━━━━⬣
        ...
        await sock.sendMessage(
            from,
            { text: '❌ Erro ao consultar RENAVAM.' },
            { quoted: msg }
        );
    }
...
case 'parentes': {
    ...
    if (!query) {
        return sock.sendMessage(from, {
            text: `❌ Informe o nome ou CPF para consulta de parentes.\n📌 Exemplo: ${config.prefix}parentes Italo Costa`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🔎 *Consultando parentes para "${query}"... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data || !data.data.length) {
            return sock.sendMessage(from, {
                text: `❌ Nenhum registro de parentes encontrado para a consulta informada.`
            }, { quoted: msg, edit: carregando.key });
        }
...
╰━━━━━━━━━━━━━━⬣
        ...
        await sock.sendMessage(
            from,
            { text: '❌ Erro ao consultar parentes.' },
            { quoted: msg }
        );
    }
...
case 'mae': {
    ...
    if (!query) {
        return sock.sendMessage(from, {
            text: `❌ Informe o nome ou CPF para consulta da mãe.\n📌 Exemplo: ${config.prefix}mae Italo Costa`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `👩‍👦 *Consultando mãe para "${query}"... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data || !data.data.length) {
            return sock.sendMessage(from, {
                text: `❌ Nenhum registro de mãe encontrado para a consulta informada.`
            }, { quoted: msg, edit: carregando.key });
        }
        ...
        const formatarBlocos = (obj, nivel = 0) => {
            ...
            if (Array.isArray(obj)) {
                // Filtra apenas mãe
                const mae = obj.filter(i => i.parentesco?.toLowerCase() === 'mãe');
                if (!mae.length) return '❌ Nenhum registro de mãe encontrado.';
                return mae
                    .map(i => formatarBlocos(i, nivel + 1))
                    .filter(Boolean)
                    .join('\n\n');
...
case 'pai': {
    ...
    if (!query) {
        return sock.sendMessage(from, {
            text: `❌ Informe o nome ou CPF para consulta do pai.\n📌 Exemplo: ${config.prefix}pai Italo Costa`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `👨‍👦 *Consultando pai para "${query}"... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data || !data.data.length) {
            return sock.sendMessage(from, {
                text: `❌ Nenhum registro de pai encontrado para a consulta informada.`
            }, { quoted: msg, edit: carregando.key });
        }
        ...
        const formatarBlocos = (obj, nivel = 0) => {
            ...
            if (Array.isArray(obj)) {
                ...
                if (!pai.length) return '❌ Nenhum registro de pai encontrado.';
                return pai
                    .map(i => formatarBlocos(i, nivel + 1))
                    .filter(Boolean)
                    .join('\n\n');
...
case 'placa': {
    ...
    if (!placa) {
        return sock.sendMessage(from, {
            text: `❌ Informe a placa do veículo.\n📌 Exemplo: ${config.prefix}placa ABC1234`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🚗 *Consultando veículo da placa "${placa}"... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para a placa informada.`
            }, { quoted: msg, edit: carregando.key });
        }
...
╰━━━━━━━━━━━━━━⬣
        ...
        await sock.sendMessage(
            from,
            { text: '❌ Erro ao consultar a placa.' },
            { quoted: msg }
        );
    }
...
case 'chassi': {
    ...
    if (!chassi) {
        return sock.sendMessage(from, {
            text: `❌ Informe o número do chassi.\n📌 Exemplo: ${config.prefix}chassi 9BWZZZ377VT004251`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `🚘 *Consultando veículo pelo chassi "${chassi}"... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o chassi informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case 'bin': {
    ...
    if (!bin) {
        return sock.sendMessage(from, {
            text: `❌ Informe um BIN válido.\n📌 Exemplo: ${config.prefix}bin 552879`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `💳 *Consultando BIN "${bin}"... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para o BIN informado.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case "placa2": {
    ...
    try {
        ...
        function formatarConsultaPlaca(texto) {
            ...
            t = t.replace(/([A-ZÁÉÍÓÚÂÊÔÃÕÇ\/\s]{3,}):/g, "\n$1:");
            ...
            t = t
                ...
                .replace(/TIPO VE[IÍ]CULO\s*:/gi, "\nTIPO VEÍCULO:")
                .replace(/ESP[EÉ]CIE\s*:/gi, "\nESPÉCIE:")
                .replace(/COMBUST[IÍ]VEL\s*:/gi, "\nCOMBUSTÍVEL:")
                .replace(/ANO MODELO\s*:/gi, "\nANO MODELO:")
                .replace(/ANO FABRICAÇÃO\s*:/gi, "\nANO FABRICAÇÃO:")
                .replace(/CARROCERIA\s*:/gi, "\nCARROCERIA:")
                .replace(/CÂMBIO\s*:/gi, "\nCÂMBIO:")
                .replace(/SITUAÇÃO DO VE[IÍ]CULO/gi, "\nSITUAÇÃO DO VEÍCULO")
                .replace(/SITUAÇÃO\s*:/gi, "\nSITUAÇÃO:")
                .replace(/LICENCIADO\s*:/gi, "\nLICENCIADO:")
                .replace(/ALERTA\s*:/gi, "\nALERTA:")
                .replace(/PROPRIET[AÁ]RIO/gi, "\nPROPRIETÁRIO")
                .replace(/NOME\s*:/gi, "\nNOME:")
                .replace(/CPF\s*:/gi, "\nCPF:")
            ...
            let linhas = t
                ...
                .filter(l =>
                    ...
                    !l.includes("PARÂMETRO UTILIZADO") &&
                    !l.includes("INFORMAÇÕES DA CONSULTA") &&
                    !l.includes("fonte:") &&
                    !l.includes("url:")
                );
        ...
        const resultado = `
╭━━━⬣ CONSULTA PLACA - ${config.NomeDoBot} ⬣━━━╮
┃ PLACA: ${placa}
┃━━━━━━━━━━━━━━━━━━
┃
${linhas.map(l => `┃  ${l}`).join("\n")}
...
case 'pix': {
    ...
    if (!chavePix) {
        return sock.sendMessage(from, {
            text: `❌ Informe a chave PIX para consulta.\n📌 Exemplo: ${config.prefix}pix italo@email.com`
        }, { quoted: msg });
    }

    try {
        const carregando = await sock.sendMessage(from, {
            text: `💸 *Consultando PIX "${chavePix}"... Aguarde!*`
        }, { quoted: msg });
        ...
        if (!data?.data) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma informação encontrada para a chave PIX informada.`
            }, { quoted: msg, edit: carregando.key });
        }
...
case "score": {
    ...
    try {
        ...
        const resultado = `
╭━━━⬣ CONSULTA SCORE - ${config.NomeDoBot} ⬣━━━╮
┃ CPF: ${cpf}
┃━━━━━━━━━━━━━━━━━━
┃
${linhas.map(l => `┃  ${l}`).join("\n")}
...
case "perfil": {
    ...
    try {
        ...
        const hierarquia = isOwner ? "👑 Dono do Grupo" : isAdmin ? "⭐ Admin do Grupo" : "👤 Membro";
        ...
        const medalhas = nivel >= 5 ? "🏅🏅🏅" : nivel >= 3 ? "🏅🏅" : "🏅";
        ...
        // Frases divertidas
        const gadoFrase = nivelGado > 80 ? "🐂 Extremamente Gado" : nivelGado > 50 ? "🐂 Gado médio" : "🐂 Baixo nível de Gado";
        const putaFrase = nivelPuta > 80 ? "😈 Safad@ master" : nivelPuta > 50 ? "😈 Um pouco safad@" : "😇 Quase anjo";
        const gostosuraFrase = nivelGostosura > 80 ? "🥵 Que gostosur@!" : nivelGostosura > 50 ? "🥵 Bem atraente" : "🙂 Bonit@";
        const inteligenciaFrase = inteligencia > 80 ? "🧠 Gênio" : inteligencia > 50 ? "🧠 Inteligente" : "🧠 Precisa estudar mais";

        // Conselhos/memes aleatórios
        const conselhos = [
            '💬 “Não se preocupe, ninguém é perfeito… exceto eu 😎”',
            '💬 “Se a vida te der limões, peça sal e tequila 🍋”',
            '💬 “Cuidado com quem te critica, eles também erram 🤡”',
            '💬 “Sorria, amanhã pode ser pior 😅”',
            '💬 “A preguiça é minha amiga fiel 🛌”',
            '💬 “Seja você mesmo… a menos que possa ser um dragão 🐉”'
        ];
        const conselhoAleatorio = conselhos[Math.floor(Math.random() * conselhos.length)];

        // Presença e dispositivos
        ...
        try {
            ...
            if (presence?.lastSeen) {
                presenca = `🕒 Último visto: ${new Date(presence.lastSeen).toLocaleString()}`;
            } else if (presence?.chatstate === "composing") {
                presenca = "✏️ Digitando...";
            } else {
                presenca = "✅ Online";
            }
            ...
            for (let p of listaPlataformas) {
                switch (p) {
                    case "android": dispositivos.push("📱 Android"); break;
                    case "ios": dispositivos.push("📱 iPhone"); break;
                    case "web": dispositivos.push("💻 WhatsApp Web"); break;
                    case "ipad": dispositivos.push("📱 iPad"); break;
                    case "desktop": dispositivos.push("💻 Desktop"); break;
...
├ 🎭 *Nome*: ${nickUsuario}
├ 📞 *WhatsApp*: +${numero}
├ 🐂 *Nível Gado*: ${nivelGado}% — ${gadoFrase}
├ 😈 *Nível Puta*: ${nivelPuta}% — ${putaFrase}
├ 🥵 *Nível Gostosura*: ${nivelGostosura}% — ${gostosuraFrase}
├ 🧠 *Inteligência*: ${inteligencia}% — ${inteligenciaFrase}
├ 🍼 *Programa*: R$${programa}
├ 📅 *Membro desde*: ${membroDesde}
├ ${presenca}
├ 📱 *Dispositivo*: ${dispositivos.join(", ")}
├ ⚡ *Comandos usados*: ${comandosUsados}
├ 💬 *Mensagens enviadas*: ${mensagens}
├ ⚠️ *Reports recebidos*: ${reports}
├ 🏅 *Medalhas*: ${medalhas}
├ 📝 *Recado*: ${statusMsg}
├ ${hierarquia}
├ 🔮 *Conselho do dia*: ${conselhoAleatorio}
╰─━━━━━━⊱ 〘 💡 BOT DRAGON 💡 〙⊰━━━━━━─╯
            `
        };
        ...
        console.error(err);
        await sock.sendMessage(from, { text: "❌ Ocorreu um erro ao buscar o perfil." }, { quoted: msg });
    }
    break;
}
...
case "hentaihd": {
    try {
        ...
        // 🔹 Fetch universal (Node 16, 18+, Termux, VPS)
        ...
        if (!termo) {
            return sock.sendMessage(from, {
                text: `❌ Informe a tag desejada.\n📌 Exemplo: ${config.prefix}hentaihd neko`
            }, { quoted: msg });
        }

        // Mensagem de carregamento
        const carregando = await sock.sendMessage(from, {
            text: `⏳ Buscando hentai HD com a tag *${termo}*...`
        }, { quoted: msg });
        ...
        if (postLinks.length === 0) {
            return sock.sendMessage(from, {
                text: `❌ Nenhuma imagem encontrada para *${termo}*`
            }, { quoted: msg, edit: carregando.key });
        }

        // Escolhe post aleatório
        const randomPost = postLinks[Math.floor(Math.random() * postLinks.length)];

        // Busca página do post
        ...
        if (!hdImage) throw new Error("Imagem não encontrada");
        ...
        await sock.sendMessage(from, {
            text: "❌ Erro ao buscar hentai HD. Tente novamente mais tarde."
        }, { quoted: msg });
    }
    break;
}
...
case "hentaihd2": {
    try {
        ...
        // 🔹 Fetch universal (Node 16, 18+, Termux, VPS, Docker)
        const fetch = global.fetch
            ? global.fetch
            : (...args) => import("node-fetch").then(({ default: fetch }) => fetch(...args));

        const user = msg.key.participant || msg.key.remoteJid;
        const username = user === msg.sender ? "Você" : `@${user.split("@")[0]}`;

        if (!args.length) {
            return sock.sendMessage(from, {
                text: `❌ Por favor, digite o nome do hentai.\n📌 Ex: ${config.prefix}hentaihd2 naruto`
            }, { quoted: msg });
        }
        ...
        // Mensagem de carregamento
        const carregando = await sock.sendMessage(from, {
            text: `⏳ Buscando hentai HD/4K com a tag *${termo}*...`
        }, { quoted: msg });
        ...
        if (!images.length) {
            return sock.sendMessage(from, {
                text: "❌ Não foi possível buscar as imagens."
            }, { quoted: msg, edit: carregando.key });
        }
        ...
        // Confirmação final
        await sock.sendMessage(from, {
            text: `✅ ${images.length} imagens HD/4K enviadas com sucesso!`
        }, { quoted: msg, edit: carregando.key });

    } catch (err) {
        console.error("Erro hentaihd2:", err);
        await sock.sendMessage(from, {
            text: "❌ Erro ao buscar hentai HD/4K. Tente novamente."
        }, { quoted: msg });
    }
    break;
}
...
case "0play3": {
    try {
        const q = args.join(" ");
        if (!q) return sock.sendMessage(from, { text: `❌ Exemplo: ${config.prefix}play nome da música` }, { quoted: msg });

        // Mensagem inicial da barra de carregamento
        let loadingMsg = await sock.sendMessage(from, { text: "☣️ ▱▱▱▱▱▱▱▱ 0% - Iniciando..." }, { quoted: msg });
        ...
        const atualizarBarra = async (percent, texto) => {
            ...
            await sock.sendMessage(from, { text: `☣️ ${barra} ${percent}% - ${texto}`, edit: loadingMsg.key });
        };

        // Etapas da barra
        await atualizarBarra(10, "Iniciando consulta...");
        await atualizarBarra(40, "Buscando música...");
        ...
        if (!res.ok) return sock.sendMessage(from, { text: "❌ Erro ao consultar a API de pesquisa." }, { quoted: msg });

        const data = await res.json();
        if (!data || !Array.isArray(data) || data.length === 0) return sock.sendMessage(from, { text: "❌ Nenhum resultado encontrado." }, { quoted: msg });

        const musica = data[0];
        if (musica?.tempo?.length >= 7) return sock.sendMessage(from, { text: "❌ Música muito longa (mais de 1 hora)." }, { quoted: msg });

        const titulo = musica?.titulo || "Não encontrado";
        const tempo = musica?.tempo || "Não informado";
        const postado = musica?.postado || "Não informado";
        const descricao = (musica?.desc || "Não informado").substring(0, 500) + "...";
...
☪️ Bot: ${config.NomeDoBot}
☪️ Pedido: @${msg.sender.split("@")[0]}`;

        // Finaliza barra
        await atualizarBarra(100, "Concluído!");
        ...
        await sock.sendMessage(from, { text: "❌ Erro ao processar a música. Tente novamente mais tarde." }, { quoted: msg });
    }
}
break;
...
case "ytmp4": {
    try {
        ...
        if (!q) {
            return sock.sendMessage(from, { 
                text: `❌ Exemplo: ${config.prefix}ytmp4 https://www.youtube.com/watch?v=VIDEO_ID\n📌 Suporta também Shorts do YouTube!` 
            }, { quoted: msg });
        }
        ...
        if (!q.match(/^(https?:\/\/)?(www\.|m\.)?(youtube\.com|youtu\.be)\/(watch\?v=|shorts\/)?[^\s]+$/)) {
            return sock.sendMessage(from, { 
                text: "❌ Link inválido. Envie um link direto do YouTube ou Shorts." 
            }, { quoted: msg });
        }
        ...
        let loadingMsg;
        try {
            loadingMsg = await sock.sendMessage(from, { text: "☣️ ▱▱▱▱▱▱▱▱ 0% - Iniciando..." }, { quoted: msg });
        } catch (err) {
            console.warn("Não foi possível criar barra de progresso:", err);
        }
        ...
        await atualizarBarra(40, "Consultando vídeo...");
        ...
        if (!res.ok) {
            ...
            return sock.sendMessage(from, { text: `❌ Erro ao consultar a API. Status: ${res.status}` }, { quoted: msg });
        }

        const data = await res.json();
        if (!data || !data.url) {
            await atualizarBarra(100, "Concluído");
            return sock.sendMessage(from, { text: "🔎 Nenhum vídeo encontrado." }, { quoted: msg });
        }
        ...
        if (sizeMB > 15) {
            return sock.sendMessage(from, { 
                text: `⚠️ O vídeo é muito grande para enviar pelo WhatsApp (~${sizeMB.toFixed(2)}MB).\n🔗 Você pode baixá-lo diretamente: ${data.url}` 
            }, { quoted: msg });
        }
        ...
        const msgInfo = `
༺ ⋆｡˚☽˚｡⋆ *SPIDERX - DOWNLOAD YT* ⋆｡˚☽˚｡⋆༻
🎬 *Título:* ${data.title || "Não encontrado"}
🕒 *Duração:* ${data.total_duration_in_seconds || "N/A"} segundos
📺 *Canal:* ${data.channel?.name || "Não encontrado"}
🔗 [Canal](${data.channel?.url || "#"})

⚡ *Compatível com vídeos e Shorts!*
༺ ⋆｡˚☽˚｡⋆ *SPIDERX - DOWNLOAD YT* ⋆｡˚☽˚｡⋆༻
`;
        await sock.sendMessage(from, { text: msgInfo }, { quoted: msg });

        // Enviar vídeo como buffer
        await sock.sendMessage(from, {
            video: videoBuffer,
            mimetype: "video/mp4",
        ...
        await sock.sendMessage(from, { 
            text: "❌ Ocorreu um erro ao baixar o vídeo. Verifique o link e tente novamente." 
        }, { quoted: msg });
    }
}
break;
...
case "yt-audio": {
    try {
        ...
        if (!q) {
            return sock.sendMessage(from, { 
                text: `❌ Exemplo: ${config.prefix}ytmp3 https://www.youtube.com/watch?v=VIDEO_ID` 
            }, { quoted: msg });
        }
        ...
        let loadingMsg;
        try {
            loadingMsg = await sock.sendMessage(from, { text: "🎧 ▱▱▱▱▱▱▱▱ 0% - Iniciando..." }, { quoted: msg });
        } catch (err) {}
        ...
        const atualizarBarra = async (percent, texto) => {
            ...
            try {
                await sock.sendMessage(from, { text: `🎧 ${bar} ${percent}% - ${texto}`, edit: loadingMsg.key });
            } catch {}
        };

        await atualizarBarra(15, "Consultando vídeo...");
        ...
        const data = await res.json();
        if (!data?.url) throw new Error("URL inválida retornada pela API");
        ...
        if (sizeMB > 15) {
            return sock.sendMessage(from, { 
                text: `⚠️ O áudio é muito grande (${sizeMB.toFixed(2)}MB).\nBaixe direto: ${data.url}` 
            }, { quoted: msg });
        }

        await atualizarBarra(100, "Concluído!");

        // Envia apenas o áudio puro
        await sock.sendMessage(from, {
            audio: audioBuffer,
            mimetype: "audio/mpeg",
        ...
        await sock.sendMessage(from, { 
            text: "❌ Ocorreu um erro ao baixar o áudio. Tente novamente." 
        }, { quoted: msg });
    }
}
break;
...
case "tiktok": {
    ...
    try {
        ...
        if (!q)
            return sock.sendMessage(from, { 
                text: `❌ Exemplo: ${config.prefix}tiktok https://vm.tiktok.com/EXEMPLO` 
            });

        // 🔧 Converte vt.tiktok.com -> vm.tiktok.com automaticamente
        const tiktokURL = q.replace("vt.tiktok.com", "vm.tiktok.com");

        // 🟢 Remove qualquer checagem de admin / dono / premium
        // Assim qualquer pessoa pode usar o comando livremente

        // ✅ Verifica se o link é válido
        if (!tiktokURL.match(/^(https?:\/\/)?(www\.|vm\.)?(tiktok\.com)\/.+$/)) {
            return sock.sendMessage(from, { text: "❌ Link inválido. Envie um link direto do TikTok." });
        }

        await sock.sendMessage(from, { text: "⏳ Baixando vídeo, aguarde..." });
        ...
        if (!data || !data.download_link) {
            return sock.sendMessage(from, { text: "❌ Nenhum vídeo encontrado." });
        }
        ...
        await sock.sendMessage(from, { text: "❌ Erro ao baixar o vídeo. Tente novamente mais tarde." });
    }
}
break;
...
case "play": {
    try {
        ...
        if (!q) return sock.sendMessage(from, { 
            text: `❌ Exemplo: ${config.prefix}play nome da música ou link\nSerá baixado apenas o áudio.` 
        }, { quoted: msg });
        ...
        await atualizarBarra(10, "Iniciando busca...");
        await atualizarBarra(40, "Pesquisando áudio...");
        await atualizarBarra(70, "Preparando download...");
        await atualizarBarra(90, "Quase pronto...");
        ...
        const res = await fetch(apiURL);
        if (!res.ok) return sock.sendMessage(from, { text: `❌ Erro ao consultar a API. Status: ${res.status}` }, { quoted: msg });

        const data = await res.json();
        if (!data || !data.url) {
            await atualizarBarra(100, "Concluído");
            return sock.sendMessage(from, { text: "🔎 Nenhum áudio encontrado." }, { quoted: msg });
        }
...
༺ ⋆｡˚☽˚｡⋆ *SPIDERX - ÁUDIO* ⋆｡˚☽˚｡⋆༻
🎵 *Título:* ${data.title || "Não encontrado"}
⏱ *Duração:* ${data.total_duration_in_seconds || "Não encontrado"} segundos
🎤 *Canal:* ${data.channel?.name || "Não encontrado"}
🔗 [Canal](${data.channel?.url || "#"})
...
`;
        ...
        await sock.sendMessage(from, { text: "🔎 Não foi possível encontrar o áudio. Tente ser mais específico." }, { quoted: msg });
    }
}
break;
...
case "playvideo2": {
    try {
        const q = args.join(" ").trim();
        if (!q) return sock.sendMessage(from, { 
            text: `❌ Exemplo: ${config.prefix}playvideo2 nome da música\nA música será baixada em áudio ou vídeo.` 
        }, { quoted: msg });
        ...
        await atualizarBarra(10, "Iniciando busca...");
        await atualizarBarra(40, "Pesquisando vídeo...");
        await atualizarBarra(70, "Preparando download...");
        await atualizarBarra(90, "Quase pronto...");

        // Busca dados no Bronxy
        const res = await fetch(`https://api.bronxyshost.com.br/api-bronxys/pesquisa_ytb?nome=${encodeURIComponent(q)}&apikey=${API_KEY_BRONXYS}`);
        if (!res.ok) return sock.sendMessage(from, { text: "❌ Erro ao consultar a API." }, { quoted: msg });

        const data = await res.json();
        if (!Array.isArray(data) || !data.length) {
            await atualizarBarra(100, "Concluído");
            return sock.sendMessage(from, { text: "🔎 Nenhum resultado encontrado." }, { quoted: msg });
        }
        ...
        if (tempoEmSegundos(videoInfo?.tempo || "0:0") > 7200) {
            await atualizarBarra(100, "Concluído");
            return sock.sendMessage(from, { text: "⏱ Este vídeo é muito longo (mais de 2 horas). Use outra busca." }, { quoted: msg });
        }

        let descricao = videoInfo?.desc || "Não encontrado";
        if (descricao.length > 300) descricao = descricao.slice(0, 300) + "...";

        const msgInfo = `
☣️ *Título:* ${videoInfo?.titulo || "Não encontrado"}
☣️ *Duração:* ${videoInfo?.tempo || "Não encontrado"}
☣️ *Postado:* ${videoInfo?.postado || "Não encontrado"}
☣️ *Descrição:* ${descricao}
`;
        ...
        try {
            ...
            await sock.sendMessage(from, { text: `⚠️ Não foi possível enviar o áudio. Link direto: ${audioUrl}` }, { quoted: msg });
        }
        ...
        try {
            ...
            if (tamanhoMB > 90) {
                await sock.sendMessage(from, { text: `⚠️ O vídeo é muito grande para enviar (~${tamanhoMB.toFixed(2)} MB). Link direto: ${videoUrl}` }, { quoted: msg });
            } else {
                await sock.sendMessage(from, {
                    video: { url: videoUrl },
                    mimetype: "video/mp4",
            ...
            await sock.sendMessage(from, { text: `⚠️ Não foi possível enviar o vídeo. Link direto: ${videoUrl}` }, { quoted: msg });
        }

    } catch (e) {
        console.log(e);
        await sock.sendMessage(from, { text: "🔎 Não foi possível encontrar resultados. Tente ser mais específico." }, { quoted: msg });
    }
}
break;
...
case "play2": {
    try {
        const q = args.join(" ");
        if (!q.trim()) return sock.sendMessage(from, { text: `❌ Exemplo: ${config.prefix}play nome da música\nA música será baixada em áudio.` }, { quoted: msg });
        ...
        await atualizarBarra(10, "Iniciando busca...");
        await atualizarBarra(40, "Pesquisando música...");
        await atualizarBarra(70, "Preparando download...");
        await atualizarBarra(90, "Quase pronto...");
...
case "BLACKBOX": {
    try {
        ...
        if (!q) {
            return sock.sendMessage(from, {
                text: `❌ Exemplo: ${config.prefix}blackbox O que é obsolescência programada?`
            }, { quoted: msg });
        }

        // Mensagem de carregamento
        await sock.sendMessage(from, {
            text: "🤖 Consultando a IA Blackbox..."
        }, { quoted: msg });
        ...
        try {
            ...
            try {
                ...
                data = { response: textResponse }; // Se não for JSON, usa texto bruto
            }

            // Se HTML ou status ruim, fallback para GET
            if (!res.ok || textResponse.startsWith("<")) throw new Error("POST falhou");
        } catch (err) {
            console.log("⚠️ Falha no POST, tentando via GET...");
        ...
        // 🔍 Extrai resposta
        const resposta = data.response || data.resposta || data.raw || "Sem resposta disponível no momento.";
        ...
        await sock.sendMessage(from, {
            text: "❌ Ocorreu um erro ao processar sua mensagem com a Blackbox."
        }, { quoted: msg });
    }
}
break;
...
case "ai": {
    try {
        const q = args.join(" ").trim();
        if (!q) return sock.sendMessage(from, { text: `❌ Exemplo: ${config.prefix}gemini Olá, como você está?` }, { quoted: msg });

        // Mensagem de carregamento
        let loadingMsg = await sock.sendMessage(from, { text: "🤖 Processando sua mensagem..." }, { quoted: msg });
        ...
        if (!data || !data.response) {
            return sock.sendMessage(from, { text: "🔎 Nenhuma resposta foi gerada pela IA." }, { quoted: msg });
        }
        ...
        await sock.sendMessage(from, { text: "❌ Ocorreu um erro ao processar sua mensagem com a Gemini." }, { quoted: msg });
    }
}
break;
...
case "play3": {
    try {
        ...
        if (!query) return sock.sendMessage(from, {
            text: `❌ Exemplo: ${config.prefix}playaudio casa do seu ze`
        }, { quoted: msg });
...
👁 *Visualizações:* ${info.viewsCount}
📅 *Postado:* ${info.uploadDate}
🔗 *Ouvir:* ${info.externalUrls?.audio}
⬇️ *Baixar:* ${info.dl_link}
`;
        ...
        await sock.sendMessage(from, { text: "❌ Erro ao processar o áudio." }, { quoted: msg });
    }
}
break;
...
case "playvideo3": {
    try {
        const query = args.join(" ").trim();
        if (!query) return sock.sendMessage(from, {
            text: `❌ Exemplo: ${config.prefix}playvideo casa do seu ze`
        }, { quoted: msg });
...
👁 *Visualizações:* ${info.viewsCount}
📅 *Postado:* ${info.uploadDate}
🔗 *Assistir:* ${info.externalUrls?.video}
⬇️ *Baixar:* ${info.dl_link}
`;
        ...
        await sock.sendMessage(from, { text: "❌ Erro ao processar o vídeo." }, { quoted: msg });
    }
}
break;
...
case "playvideo": {
    try {
        const q = args.join(" ").trim();
        if (!q) return sock.sendMessage(from, { 
            text: `❌ Exemplo: ${config.prefix}playvideo MC Kevinho\nSerá baixado apenas o vídeo.` 
        }, { quoted: msg });
...
🎬 *SPIDERX - VÍDEO*
🎵 *Título:* ${data.title || "Não encontrado"}
⏱ *Duração:* ${data.total_duration_in_seconds || "Desconhecida"} segundos
🎤 *Canal:* ${data.channel?.name || "Não encontrado"}
🔗 [Canal](${data.channel?.url || "#"})
...
`;
        ...
        await sock.sendMessage(from, { text: "❌ Não foi possível baixar o vídeo. Tente ser mais específico." }, { quoted: msg });
    }
}
break;
...
case "flux": {
    try {
        const q = args.join(" ").trim();
        if (!q) return sock.sendMessage(from, { text: `❌ Exemplo: ${config.prefix}flux Um cachorro azul brincando no parque` }, { quoted: msg });

        // Mensagem inicial da barra de carregamento
        let loadingMsg = await sock.sendMessage(from, { text: "🎨 ▱▱▱▱▱▱▱▱ 0% - Iniciando..." }, { quoted: msg });

        const atualizarBarra = async (percent, texto) => {
            const total = 8;
            const preenchido = Math.round((percent / 100) * total);
            const barra = "▰".repeat(preenchido) + "▱".repeat(total - preenchido);
            await sock.sendMessage(from, { text: `🎨 ${barra} ${percent}% - ${texto}`, edit: loadingMsg.key });
        };

        await atualizarBarra(10, "Recebendo requisição...");
        ...
        if (!data || !data.image) {
            await atualizarBarra(100, "Concluído");
            return sock.sendMessage(from, { text: "🔎 Nenhuma imagem foi gerada." }, { quoted: msg });
        }
        ...
        await sock.sendMessage(from, { text: "❌ Ocorreu um erro ao gerar a imagem." }, { quoted: msg });
    }
}
break;
...
case 'gerarnick': {
    try {
        const q = args.join(" ");
        if (!q.trim()) {
            return sock.sendMessage(from, { text: `❌ Escreva um nome para eu enviar ele com letras modificadas.\nExemplo: ${config.prefix + command} bronxys` }, { quoted: msg });
        }

        // Mensagem de carregamento
        const carregando = await sock.sendMessage(from, { text: "☣️ AGUARDE, GERANDO LISTA DE NICKS..." }, { quoted: msg });
        ...
        let AB = `✨ Lista com base no nick informado:\n\n`;
        for (const i of ABC) {
            AB += `${i}\n\n`;
        }
        ...
        console.error(e);
        return sock.sendMessage(from, { text: "❌ Ocorreu um erro ao gerar os nicks." }, { quoted: msg });
    }
    break;
}
...
case 'figurinha': {
  try {
    ...
    if (!media) return sock.sendMessage(from, { text: '❌ Envie ou marque uma imagem, vídeo ou GIF!' }, { quoted: msg });
    ...
    // ⚙️ Verifica se é vídeo, imagem ou gif animado
    ...
    await sock.sendMessage(from, { text: '❌ Erro ao criar figurinha. Envie uma imagem, GIF ou vídeo curto (≤10s).' }, { quoted: msg });
  }
  break;
}
...
case 'webp2img': {
  try {
    ...
    if (!media) return sock.sendMessage(from, { text: '❌ Envie ou marque uma figurinha para converter!' }, { quoted: msg });
    ...
    // ⚙️ Detecta se é figurinha animada
    const isAnimated = media.isAnimated || buffer.includes(Buffer.from('ANMF')); // ANMF = chunk de animação WebP

    // 🎞️ Comando ffmpeg adequado
    ...
    if (isAnimated) {
      ...
      await sock.sendMessage(from, { video: gifBuffer, gifPlayback: true, caption: '🎬 Figurinha convertida em GIF!' }, { quoted: msg });
      fs.unlinkSync(outputAnimated);
    } else {
      const imgBuffer = fs.readFileSync(outputStatic);
      await sock.sendMessage(from, { image: imgBuffer, caption: '🖼️ Figurinha convertida em imagem!' }, { quoted: msg });
    ...
    await sock.sendMessage(from, { text: '❌ Erro ao converter a figurinha. Tente novamente!' }, { quoted: msg });
  }
  break;
}
...
case "pinterest": {
    ...
    if (!q) {
        return sock.sendMessage(from, { 
            text: `❌ Digite o nome da imagem que deseja buscar\nExemplo: ${config.prefix}pinterest Goku`
        }, { quoted: msg });
    }

    const senderId = msg.key.participant || msg.key.remoteJid;
    await sock.sendMessage(from, { 
        text: `⏳ ${new Date().toLocaleTimeString("pt-BR")}, @${senderId.split('@')[0]}.\n*Estou buscando imagens sobre "${q}"...*`,
    ...
    try {
        ...
        if (!data || !data.resultado || data.resultado.length === 0) {
            return sock.sendMessage(from, { 
                text: `⚠️ Nenhuma imagem encontrada para: ${q}` 
            }, { quoted: msg });
        }
...
case "pinterest2": {
    ...
    try {
        ...
        // ▓▓▓ EMBARALHAMENTO INTELIGENTE (SEM REPETIÇÃO) ▓▓▓
        ...
        // pega as 3 primeiras (todas únicas)
...
// Inicializa memória global se não existir
if (!global.wallpapersEnviados) {
    global.wallpapersEnviados = new Set();
    // Limpeza automática a cada 1 hora
    setInterval(() => {
        console.log("🗑️ Limpando memória de wallpapers enviados...");
...
case "wp": {
    ...
    if (!q) {
        return sock.sendMessage(from, { 
            text: `❌ Digite o nome do wallpaper.\nExemplo: ${config.prefix}wallpaper Naruto`
        }, { quoted: msg });
    }

    const senderId = msg.key.participant || msg.key.remoteJid;
    await sock.sendMessage(from, { 
        text: `🖼️ @${senderId.split('@')[0]}, buscando wallpapers 2K / Full HD sobre "${q}"...`,
        contextInfo: { mentionedJid: [senderId] }
    });
    ...
    try {
        ...
        if (!data?.resultado?.length) {
            return sock.sendMessage(from, { text: `⚠️ Nenhum wallpaper encontrado para: ${q}` }, { quoted: msg });
        }
        ...
        if (!validas.length) {
            return sock.sendMessage(from, { text: "⚠️ Nenhum wallpaper novo em alta qualidade encontrado." }, { quoted: msg });
        }

        // Embaralha resultados e seleciona até 3
        ...
        for (const w of selecionados) {
            try {
                ...
                await sock.sendMessage(from, { 
                    ...
                    caption: `🖼️ *${w.titulo}*\n📥 [Baixar em alta qualidade](${w.link})\n🔗 ${w.pagina}`
                }, { quoted: msg });
        ...
        await sock.sendMessage(from, { text: "❌ Ocorreu um erro ao buscar wallpapers." }, { quoted: msg });
    }
}
break;
...
// Histórico global de vídeos enviados
// Chave: videoUrl, Valor: timestamp de envio
const globalSentVideos = new Map();

// Tempo mínimo para repetir o mesmo vídeo (em ms)
...
case "xvideos": {
    ...
    const bannedTerms = [
        ...
        "criança", "adolescen", "preteen", "underage", "12", "13", "14", "15"
    ];
    const lowerQ = q.toLowerCase();
    for (const t of bannedTerms) if (lowerQ.includes(t)) {
        return sock.sendMessage(from, {
            text: `❌ Busca bloqueada: o termo usado é proibido.`
        }, { quoted: msg });
    }

    const senderId = msg.key.participant || msg.key.remoteJid;
    await sock.sendMessage(from, {
        text: `🔍 @${senderId.split('@')[0]}, pesquisando "${q}"...`,
        contextInfo: { mentionedJid: [senderId] }
    });
    ...
    try {
        ...
        if (!Array.isArray(resultados) || resultados.length === 0) {
            return sock.sendMessage(from, { text: `⚠️ Nenhum resultado encontrado para: ${q}` }, { quoted: msg });
        }

        const mapped = resultados.map(item => ({
            title: item.title || item.name || item.video_title || "Vídeo",
        ...
        if (!mapped.length) {
            return sock.sendMessage(from, { text: `⚠️ Resultados encontrados, mas sem links válidos.` }, { quoted: msg });
        }

        // Filtra vídeos que não foram enviados recentemente
        ...
        if (!disponiveis.length) {
            return sock.sendMessage(from, { text: `⚠️ Todos os vídeos já foram enviados recentemente.` }, { quoted: msg });
        }

        // Seleciona até 3 vídeos aleatoriamente
        const selecionados = [];
        ...
        for (const r of selecionados) {
            try {
                if (r.thumb) {
                    await sock.sendMessage(from, {
                        image: { url: r.thumb },
                        caption: `🎥 *${r.title}*\n🔗 ${r.page}\n${r.videoUrl ? `▶️ Link direto: ${r.videoUrl}` : ""}`
                    }, { quoted: msg });
                } else if (r.videoUrl) {
                    await sock.sendMessage(from, {
                        text: `🎥 *${r.title}*\n🔗 ${r.page}\n▶️ Link direto: ${r.videoUrl}`
                    }, { quoted: msg });
                } else {
                    await sock.sendMessage(from, { text: `🎥 *${r.title}*\n🔗 ${r.page}` }, { quoted: msg });
                }
...
case "pinmp4": {
    try {
        ...
        // Função auxiliar: baixa e retorna buffer
        ...
        if (!q) {
            return sock.sendMessage(from, { 
                text: `❌ Envie o link do Pinterest.\nExemplo: ${config.prefix + command} https://pin.it/4JWC02Bye`
            }, { quoted: msg });
        }

        // Mensagem de carregamento
        await sock.sendMessage(from, { 
            text: `⏳ Baixando vídeo do Pinterest...\n🖇️ Link: ${q}`
        }, { quoted: msg });

        // Função com tentativas e timeout
        ...
        try {
            ...
            if (status === 502 || (status && status >= 500)) {
                return sock.sendMessage(from, { 
                    text: "⚠️ A API retornou erro 502/5xx. Tente novamente mais tarde."
                }, { quoted: msg });
            }
            return sock.sendMessage(from, { 
                text: "⚠️ Não foi possível contatar a API de download. Tente novamente em alguns minutos."
            }, { quoted: msg });
        }
        ...
        if (!data || !data.resultado || !data.resultado.dl_link) {
            return sock.sendMessage(from, { 
                text: "⚠️ Não consegui encontrar o vídeo no link enviado." 
            }, { quoted: msg });
        }
        ...
        try {
            await sock.sendMessage(from, {
                video: { url: dlUrl },
                mimetype: "video/mp4",
                caption: `_*📌 Vídeo do Pinterest:*_\n╰┈➤ _Pedido por:_ *${pushname}*\n🪄 _Baixado por:_ *${NomeDoBot}*`,
        ...
        try {
            ...
            console.error("Erro ao baixar/enviar o vídeo como buffer:", errBuffer);
            const statusDl = errBuffer?.response?.status;
            if (statusDl === 502 || (statusDl && statusDl >= 500)) {
                return sock.sendMessage(from, { 
                    text: "⚠️ O servidor do vídeo retornou erro 502. Tente novamente mais tarde."
                }, { quoted: msg });
            }
            return sock.sendMessage(from, { 
                text: "⚠️ Erro ao baixar ou enviar o vídeo. Pode ser grande demais ou o servidor está fora do ar."
            }, { quoted: msg });
        }
        ...
        await sock.sendMessage(from, { 
            text: "⚠️ Erro ao baixar o vídeo do Pinterest." 
        }, { quoted: msg });
    }
}
break;
  ...
  try {
    ...
    if (!q) {
      return await sock.sendMessage(from, {
        text: `❌ Insira a URL de um vídeo do Instagram.\n\nExemplo: ${prefix}instagram https://www.instagram.com/reel/xxxxx`
      }, { quoted: info });
    }

    await sock.sendMessage(from, {
      text: `⏳ Baixando vídeo do Instagram para você, ${pushname}...`
    }, { quoted: info });
    ...
    if (!data || !data.resultado || !data.resultado.url) {
      return await sock.sendMessage(from, { 
        text: "❌ Não foi possível baixar este vídeo. Verifique se a URL está correta." 
      }, { quoted: info });
    }

    await sock.sendMessage(from, {
      video: { url: data.resultado.url },
      caption: `🎥 *Aqui está o seu vídeo do Instagram!*\n👤 *Pedido por:* _${pushname}_\n🤖 *Baixado por:* _${NomeDoBot}_`
    }, { quoted: info });
...
case "scdl": {
    const q = args.join(" ").trim();
    if (!q) {
        return sock.sendMessage(from, { text: "❌ Você esqueceu de colocar a URL da música do SoundCloud." }, { quoted: msg });
    }

    await sock.sendMessage(from, { text: "🔄 Baixando música, aguarde..." }, { quoted: msg });
    ...
    if (!sucesso) {
        return sock.sendMessage(from, { text: "❌ Não foi possível baixar a música. Todas as APIs falharam." }, { quoted: msg });
    }
}
break;
...
case "fbdl": {
  try {
    ...
    if (!q) {
      return await sock.sendMessage(from, {
        text: `❌ Você esqueceu de adicionar um link do Facebook.\n\nExemplo: ${prefix}facebook https://www.facebook.com/share/v/1BgSHdVCnW/`
      }, { quoted: info });
    }

    await sock.sendMessage(from, {
      text: `📥 Baixando mídia do Facebook para você, ${pushname}...`
    }, { quoted: info });
    ...
    if (!data || !data.resultado || !data.resultado.resultado) {
      return await sock.sendMessage(from, { 
        text: "⚠️ Erro ao baixar a mídia. Verifique se o link é válido e tente novamente." 
      }, { quoted: info });
    }

    const fb = data.resultado.resultado;

    // 🔽 Verifica se tem link de vídeo (HD ou SD)
    if (fb.dl_link && (fb.dl_link.HD || fb.dl_link.SD)) {
      ...
      await sock.sendMessage(from, {
        video: { url: videoUrl },
        caption: `🎬 *Aqui está o seu vídeo do Facebook!*\n👤 *Pedido por:* _${pushname}_\n🤖 *Baixado por:* _${NomeDoBot}_`
      }, { quoted: info });

    // 🔽 Caso seja imagem (em alguns posts)
    } else if (fb.imagem) {
      await sock.sendMessage(from, {
        image: { url: fb.imagem },
        caption: `🖼️ *Imagem baixada do Facebook!*\n👤 *Pedido por:* _${pushname}_\n🤖 *Baixado por:* _${NomeDoBot}_`
      }, { quoted: info });

    } else {
      await sock.sendMessage(from, { 
        text: "⚠️ Não foi possível encontrar um link válido para download." 
      }, { quoted: info });
    }
    ...
    await sock.sendMessage(from, { 
      text: `❌ Ocorreu um erro ao processar o download: ${error.message}` 
    }, { quoted: msg });
  }
}
break;
...
case 'gerarlink': {
    ...
    try {
        ...
        // Checar se a mensagem atual ou citada contém imagem
        ...
        // Mensagem citada (resposta)
            ...
            return sock.sendMessage(from, { text: `*Envie ou responda uma _Imagem/Vídeo_ com o comando _${config.prefix + command}_*` }, { quoted: msg });
        }
        ...
        if (response.data?.resultado?.url) {
            ...
            await sock.sendMessage(from, { text: "⚠️ Erro ao gerar o link, tente novamente." }, { quoted: msg });
        }

    } catch (e) {
        console.error("Erro na case gerarlink:", e);
        await sock.sendMessage(from, { text: `❌ Erro: ${e.message}. Tente novamente.` }, { quoted: msg });
    }
}
break;
...
case 'upload': {
  try {
    ...
    if (!isQuotedImage && !isQuotedVideo && !isQuotedSticker) return sock.sendMessage(from, { text: '❗ Marque uma imagem, vídeo ou figurinha.' }, { quoted: msg });
    ...
    sock.sendMessage(from, { text: `✅ Link gerado: ${mediaUrl}` }, { quoted: msg });

  } catch (e) {
    console.error(e);
    sock.sendMessage(from, { text: '❌ Erro ao tentar converter a mídia para link.' }, { quoted: msg });
  }
  break;
}       
...
case 'attp2': {
    try {
        const q = args.join(" ");
        if (!q.trim()) {
            return sock.sendMessage(from, { text: `❌ Exemplo: ${config.prefix + command} bronxys` }, { quoted: msg });
        }

        // Mensagem de carregamento
        const carregando = await sock.sendMessage(from, { text: "☣️ AGUARDE, REALIZANDO AÇÃO..." }, { quoted: msg });
        ...
        await sock.sendMessage(from, { sticker: { url } }, { quoted: msg })
            .catch(() => sock.sendMessage(from, { text: "❌ Ocorreu um erro ao gerar o sticker." }, { quoted: msg }));

        // Atualiza a mensagem de carregamento para concluída
        await sock.sendMessage(from, { text: "✅ Sticker gerado com sucesso!" }, { quoted: msg, edit: carregando.key });
        ...
        console.error(e);
        return sock.sendMessage(from, { text: "❌ Ocorreu um erro." }, { quoted: msg });
    }
    break;
}
...
case 'checkban': {
    ...
    try {
        // ⏳ Mensagem de carregamento
        const carregando = await sock.sendMessage(from, { 
            text: `🔍 Verificando status do número: +${numero}...\n⏳ Aguarde...` 
        }, { quoted: msg });
...
`;
        ...
        if (resultData?.banido) {
            statusMsg += `┃ 🚫 *STATUS:* BANIDO\n┃━━━━━━━━━━━━━━━━━━━━━━━\n┃ ⚠️ *Detalhes:*\n┃ • Motivo: ${resultData.motivo || 'Desconhecido'}\n┃ • Pode recorrer: ${resultData.podeRecorrer ? 'Sim' : 'Não'}\n`;
            if (resultData.tokenRecorrencia) {
                statusMsg += `┃ • Token de recurso: \`${resultData.tokenRecorrencia}\`\n`;
            }
            statusMsg += `┃━━━━━━━━━━━━━━━━━━━━━━━\n┃ 💡 *Dica:* Use o WhatsApp oficial para recorrer\n╰━━━━━━━━━━━━━━⬣`;
        } else if (resultData?.restrito) {
            statusMsg += `┃ 🔒 *STATUS:* RESTRITO\n┃━━━━━━━━━━━━━━━━━━━━━━━\n┃ ⚠️ *Motivo:* Deve usar WhatsApp oficial\n┃ 💡 *Dica:* Troque para o app oficial do WhatsApp\n╰━━━━━━━━━━━━━━⬣`;
        } else {
            statusMsg += `┃ ✅ *STATUS:* LIMPO\n┃━━━━━━━━━━━━━━━━━━━━━━━\n┃ 🎉 O número *NÃO ESTÁ BANIDO*\n┃ ✅ Seguro para usar em qualquer WhatsApp\n╰━━━━━━━━━━━━━━⬣`;
        }
        ...
        await sock.sendMessage(from, { 
            text: `❌ Ocorreu um erro ao verificar o status do número!\nTente novamente mais tarde.` 
        }, { quoted: msg });
    }
    break;
}
...
case "ping": {
    try {
        ...
        const msgCarregando = await sock.sendMessage(from, { text: "🏓 *Pingando...*" }, { quoted: msg });
...
`.trim();
        ...
        await sock.sendMessage(from, { text: "❌ Ocorreu um erro ao executar o comando /ping." }, { quoted: msg });
    }
}
break;
...
async function verificarMensagem(sock, from, msg, body, isGroup, BOT_PHONE) {
    ...
    await sock.sendMessage(from, { text: "🚫 *Link detectado!*\nLinks não são permitidos neste grupo." });
...
case 'antilink': {
    ...
    // Pega permissões do usuário e do bot
    ...
    if (!permsUsuario.isAdmin && !permsUsuario.isOwnerGroup) {
        return sock.sendMessage(from, { text: "❌ Apenas administradores podem ativar/desativar." }, { quoted: msg });
    }

    if (!args[0]) return sock.sendMessage(from, { text: "❌ Use: 1 para ativar, 0 para desativar\nExemplo: .antilink 1" }, { quoted: msg });
    ...
    await sock.sendMessage(from, { text: `✅ Anti-link ${args[0] === '1' ? 'ativado' : 'desativado'} no grupo!` }, { quoted: msg });
...
case "antilinkgp": {
    if (!isGroup) return sock.sendMessage(from, { text: "❌ Só funciona em grupos." }, { quoted: msg });

    const perms = await getPermissions(sock, from, msg.key.participant, BOT_PHONE);
    if (!perms.isAdmin && !perms.isOwnerGroup) {
        return sock.sendMessage(from, { text: "❌ Apenas administradores podem usar." }, { quoted: msg });
    }
...
logActivity('ANTILINK_TRIGGERED', {
  ...
  isGroup
    ...
    return sock.sendMessage(from, { text: `🛡️ Anti-link do Grupo ${gp.antilinkGp ? "✅ ATIVADO" : "❌ DESATIVADO"}` }, { quoted: msg });
}
break;
...
case 'promover': {
  ...
  if (!perms.isAdmin && !perms.isOwnerGroup) return sock.sendMessage(from, { text: '❌ *Apenas administradores podem usar este comando.*' }, { quoted: msg });

  // Verifica se o bot é admin
  const metadata = await sock.groupMetadata(from);
  const botIsAdmin = metadata.participants.some(p => p.id === BOT_PHONE + "@s.whatsapp.net" && p.admin);
  if (!botIsAdmin) return sock.sendMessage(from, { text: "⚠️ *Eu preciso ser administrador para promover alguém.*" }, { quoted: msg });

  // Pega o usuário marcado ou digitado
  let targetJid = msg.message?.extendedTextMessage?.contextInfo?.mentionedJid?.[0] || msg.quoted?.sender || args[0];
  if (!targetJid) return sock.sendMessage(from, { text: '❌ *Marque o usuário com @ ou responda a mensagem dele.*' }, { quoted: msg });
  ...
  try {
    ...
    console.error(err);
    await sock.sendMessage(from, { text: '❌ *Ocorreu um erro ao tentar promover o usuário.*' }, { quoted: msg });
  }
}
break;

case "nuke": {
  if (!isCreator) return sock.sendMessage(from, { text: "❌ Só o dono pode usar esse comando." }, { quoted: msg });
  ...
  try {
    ...
    await sock.sendMessage(from, {
      text: `💥 *Nuke concluído!*\n\n👥 Total de participantes no grupo: *${totalParticipants}*\n🔻 Admins rebaixados: *${adminsToDemote.length}*\n❌ Membros removidos: *${membersToRemove.length}*`
    }, { quoted: msg });

  } catch (err) {
    console.error(err);
    await sock.sendMessage(from, { text: `⚠️ Erro ao executar nuke: ${err.message}` }, { quoted: msg });
  }
}
break;
...
case "nuke2": {
  ...
  try {
    ...
    await sock.sendMessage(from, {
      text: `💥 *Nuke2 concluído!*\n\n👥 Total de participantes no grupo: *${totalParticipants}*\n🔻 Admins rebaixados: *${adminsToDemote.length}*`
    }, { quoted: msg });

  } catch (err) {
    console.error(err);
    await sock.sendMessage(from, { text: `⚠️ Erro ao executar nuke2: ${err.message}` }, { quoted: msg });
  }
}
break;
...
case 'rebaixar': {
    ...
    // detecta JID do bot por várias propriedades comuns
    let rawBot = null;
    try {
        if (sock && sock.user) {
    ...
    // encontra participante por comparação tolerante
    ...
    // validações básicas
    if (!isUserAdmin) {
        return sock.sendMessage(from, { text: '❌ *Apenas administradores podem usar este comando.*' }, { quoted: msg });
    }

    // determina alvo: menção, reply ou número
    let alvo;
    try {
    ...
    if (!alvo) {
        return sock.sendMessage(from, {
            text: `❌ *Uso incorreto!*\n\n📌 Exemplo: ${config.prefix}rebaixar @usuário ou responda à mensagem dele.`
        }, { quoted: msg });
    }

    // não rebaixar o dono do grupo
    const ownerJid = toFullJid(meta.owner || meta.owner?.id);
    if (ownerJid && equalJid(ownerJid, alvo)) {
        return sock.sendMessage(from, { text: '❌ *Não posso rebaixar o dono do grupo.*' }, { quoted: msg });
    }
    ...
    if (!alvoParticipant || !alvoIsAdmin) {
        return sock.sendMessage(from, { text: '❌ *Este usuário já não é administrador.*' }, { quoted: msg });
    }

    // se detectamos que o bot é admin, prosseguimos normalmente
    if (isBotAdmin) {
        try {
            await sock.groupParticipantsUpdate(from, [alvo], 'demote');
            return sock.sendMessage(from, { text: '✅ *Usuário rebaixado com sucesso.*' }, { quoted: msg });
        } catch (err) {
            console.error('Erro ao demote (bot detectado como admin):', err);
            return sock.sendMessage(from, { text: `❌ *Falha ao rebaixar o usuário.*\nErro: ${err?.message || String(err)}` }, { quoted: msg });
        }
    }

    // ======= fallback / tentativa mesmo sem detectar admin =======
    // Às vezes a detecção falha — tentamos executar o demote mesmo assim e entregamos diagnóstico detalhado se falhar.
    try {
        await sock.groupParticipantsUpdate(from, [alvo], 'demote');
        return sock.sendMessage(from, { text: '✅ *Usuário rebaixado com sucesso (fallback).*' }, { quoted: msg });
    } catch (err) {
        console.error('Erro ao demote (fallback):', err);

        // Monta diagnóstico resumido (IDs + flags de admin)
        ...
        // envia diagnóstico para você colar aqui — é seguro e ajuda a identificar o problema
        await sock.sendMessage(from, {
            text:
`❌ *Falha ao rebaixar (demote falhou).*  
🔍 Enviando diagnóstico para análise — cole o conteúdo aqui se quiser que eu examine:

\`\`\`
${JSON.stringify(diag, null, 2)}
\`\`\`

➡️ Erro retornado: ${err?.message || String(err)}`
        }, { quoted: msg });
...
case "promover": {
    ...
    if (!perms.isBotAdmin) {
        return sock.sendMessage(from, { text: "⚠️ Eu preciso ser admin para promover alguém." });
    }

    const mentioned = msg.message?.extendedTextMessage?.contextInfo?.mentionedJid || [];
    const alvo = mentioned[0] || args[0];
    if (!alvo) return sock.sendMessage(from, { text: "❌ Uso: .promover @usuário" });
    ...
    try {
        ...
        return sock.sendMessage(from, { text: "✅ Usuário promovido a administrador!" });
    } catch (e) {
        console.error(e);
        return sock.sendMessage(from, { text: "❌ Erro ao promover o usuário." });
    }
}
break;
...
case "silenciar": {
    ...
    if (!perms.isAdmin && !perms.isOwnerGroup) {
        return sock.sendMessage(from, { text: "🚫 Apenas administradores podem silenciar o grupo." }, { quoted: msg });
    }

    if (mutedGroups.has(from)) {
        return sock.sendMessage(from, { text: "🔇 O grupo já está silenciado." }, { quoted: msg });
    }

    mutedGroups.add(from);
    await sock.sendMessage(from, { text: "✅ Grupo silenciado! Comandos estão temporariamente bloqueados." }, { quoted: msg });
}
break;
...
case "dessilenciar": {
    ...
    if (!mutedGroups.has(from)) {
        return sock.sendMessage(from, { text: "🔊 O grupo já está liberado." }, { quoted: msg });
    }

    mutedGroups.delete(from);
    await sock.sendMessage(from, { text: "✅ Grupo desmutado! Os comandos estão liberados novamente." }, { quoted: msg });
}
break;



// ❌ Bloqueia comandos se o grupo estiver mutado
if (isGroup && mutedGroups.has(from)) {
    return sock.sendMessage(from, { text: "🔇 Este grupo está silenciado. Aguarde até ser desmutado." }, { quoted: msg });
}
...
case "fechargp": {
  // Só grupos
  if (!isGroup) return sock.sendMessage(from, { text: "❌ Este comando só funciona em grupos." });
  ...
  if (!args[0]) {
    return sock.sendMessage(from, {
      text: `❌ Uso incorreto!\n\nExemplo:\n${config.prefix}fechargp 1 → Fechar o grupo (somente admins enviam)\n${config.prefix}fechargp 0 → Abrir o grupo (todos enviam)`
    });
  }

  // Reconstruir JID do bot para instruções caso precise promover
  const botJid = `${BOT_PHONE}@s.whatsapp.net`;

  // Tentar detectar se o bot é admin via metadata (mais robusto)
  let isBotAdmin = false;
  try {
    const metadata = await sock.groupMetadata(from);
    const botPart = metadata.participants.find(p => p.id === botJid);
    // checagens diferentes dependendo da versão da lib
    isBotAdmin = Boolean(
      botPart &&
      (botPart.admin === 'admin' || botPart.admin === 'superadmin' || botPart.admin === true || botPart.isAdmin)
    );
  } catch (e) {
    // não fatal — continuamos e tratamos no catch abaixo
    console.error('Erro ao obter metadata do grupo:', e);
  }

  // Função auxiliar para aplicar alteração (fallbacks se API variar)
  const applySetting = async (jid, setting) => {
    if (typeof sock.groupSettingUpdate === 'function') {
      return sock.groupSettingUpdate(jid, setting);
    }
    // fallback genérico (caso sua lib tenha outro método)
    if (typeof sock.groupUpdate === 'function') {
      // alguns adaptadores usam assinaturas diferentes — tentar chamar de forma genérica
      try { return await sock.groupUpdate(jid, setting); } catch {}
    }
    throw new Error('Método de atualização de grupo não disponível no socket.');
  };
  ...
  try {
    if (args[0] === '1') {
      ...
      await sock.sendMessage(from, { text: '🔒 *Grupo fechado com sucesso!* \nSomente administradores podem enviar mensagens agora.' });
      ...
      await sock.sendMessage(from, { text: '🔓 *Grupo aberto com sucesso!* \nTodos os membros podem enviar mensagens novamente.' });
      logActivity('CONFIG_CHANGED', { setting: 'Fechar Grupo', value: false, groupId: from, groupName: perms.groupName, isGroup: true });
    } else {
      return sock.sendMessage(from, { text: '⚠️ Parâmetro inválido. Use 1 para fechar e 0 para abrir o grupo.' });
    }
  } catch (err) {
    console.error('Erro ao alterar configuração do grupo:', err);

    // Se detectamos que o bot não é admin, fornecer instrução clara para o usuário
    if (!isBotAdmin) {
      return sock.sendMessage(from, {
        text:
`⚠️ Eu preciso ser administrador para alterar esta configuração.

Por favor promova o bot como administrador e tente novamente.

Como fazer:
1. Toque no nome do grupo → Informações do grupo.
2. Vá em "Administradores" ou "Configurações do grupo".
...
Depois disso, execute novamente: ${config.prefix}fechargp 1`
    ...
    return sock.sendMessage(from, { text: '❌ Ocorreu um erro ao tentar alterar as configurações do grupo. Tente novamente mais tarde.' });
  }
...
case "vacinas": {
    ...
    if (!valor) {
        return sock.sendMessage(from, {
            text: `❌ *INFORME O VALOR DA CONSULTA.*\n📌 *EXEMPLO:* *${config.prefix}vacinas 12345678900*`
        }, { quoted: msg });
    }

    try {
        let carregando = await sock.sendMessage(from, {
            text: `💉 *CONSULTANDO VACINAS ${valor.toUpperCase()}... AGUARDE!*`
        }, { quoted: msg });
        ...
        if (!data || !data.data) {
            return sock.sendMessage(from, {
                text: `❌ *NENHUM RESULTADO ENCONTRADO PARA VACINAS ${valor.toUpperCase()}.*`,
                edit: carregando.key
            }, { quoted: msg });
        }
...
case "marcar": {
    ...
    let texto = `📢 *Marcações do grupo ${metadata.subject}*\n\n`;
...
case "hidetag2": {
    ...
    try {
        ...
        const texto = args.length > 0
            ? args.join(" ")
            : "*📢 Atenção a todos do grupo!*";

        // 🔹 Mensagem final (caption)
        const caption = `༺⋆☽˚ *𝑨𝑽𝑰𝑺𝑶 𝑫𝑶 𝑨𝑫𝑴𝑰𝑵* ˚☽˚༻
...
${texto}
        ...
        // 🔹 Envia imagem + legenda mencionando todos
        await sock.sendMessage(from, {
            image: { url: profilePic },
            caption: caption,
            mentions: members
...
case "hidetag": {
    if (!isGroup) {
        return sock.sendMessage(from, { text: "❌ Esse comando só funciona em grupos." }, { quoted: msg });
    }
    ...
    try {
        ...
        console.error("Erro no comando hidetag:", e);
        await sock.sendMessage(from, { text: "❌ Erro ao tentar mencionar todos." }, { quoted: msg });
    }
...
case "ban": {
    ...
    // Array de donos
    const owners = [config.numerodono]; // coloque todos os números dos donos aqui
    ...
    if (!mentioned || mentioned.length === 0) {
        return sock.sendMessage(from, { text: `❌ Marque alguém para remover.\nExemplo: ${config.prefix}ban @user` }, { quoted: msg });
    }

    const alvo = mentioned[0];
    const nomeAlvo = "@" + alvo.split("@")[0];

    // Proteção: não banir dono ou próprio bot
    if (alvo === BOT_PHONE + "@s.whatsapp.net") 
        return sock.sendMessage(from, { text: "🤖 Não posso me remover." }, { quoted: msg });

    if (owners.some(ownerNum => alvo.includes(ownerNum.replace(/[^0-9]/g, "")))) 
        return sock.sendMessage(from, { text: "👑 Não é possível remover o dono." }, { quoted: msg });

    // Verifica se o alvo é admin
    const metadata = await sock.groupMetadata(from);
    const targetIsAdmin = metadata.participants.find(p => p.id === alvo)?.admin;
    if (targetIsAdmin) return sock.sendMessage(from, { text: "⚠️ Não posso remover outro administrador." }, { quoted: msg });
    ...
    try {
        ...
        // Mensagem de sucesso
        await sock.sendMessage(from, {
            text: `✅ Usuário ${nomeAlvo} removido com sucesso!\n👮‍♂️ Removido por: @${msg.key.participant.split("@")[0]}`,
...
case "perfil": {
    ...
    try {
        ...
        ppUrl = "https://i.ibb.co/2FsfXqM/erro-pp.jpg"; // fallback caso não haja foto
    }
    ...
    try {
        ...
        bioperfil = result[0]?.status?.status || "Bio não pública ou não definida"; // fallback
    } catch {
        bioperfil = "Não foi possível obter a bio";
    }

    // Nome do usuário de forma segura
...
│
│ 🎭 Nome: ${pushname}
│ 📞 WhatsApp: wa.me/${userJid.split("@")[0]}
│ 🖋️ Bio: ${bioperfil}
│
│ 🐂 Nível Gado: ${nivelGado}%
│ 😈 Nível Puta: ${nivelPuta}%
│ 🥵 Nível Gostosura: ${nivelGostosura}%
...
case 'apagar': {
    if (!isGroup) {
        return sock.sendMessage(from, { text: "❌ Esse comando só pode ser usado em grupos." }, { quoted: msg });
    }

    const quoted = msg.message?.extendedTextMessage?.contextInfo;
    if (!quoted?.stanzaId || !quoted?.participant) {
        return sock.sendMessage(from, { text: "❌ Responda a mensagem que deseja apagar." }, { quoted: msg });
    }
    ...
    try {
        ...
        await sock.sendMessage(from, { 
            text: `🗑️ *MENSAGEM DE* @${quoted.participant.split("@")[0]} *APAGADA COM SUCESSO!*`, 
            mentions: [quoted.participant] 
        }, { quoted: msg });

    } catch (err) {
        console.error("Erro ao apagar (Versão 1):", err);
        return sock.sendMessage(from, { text: "❌ Erro ao tentar apagar a mensagem (V1)." }, { quoted: msg });
    }
}
break;
...
case 'apagar2': {
    ...
    try {
        ...
        console.error("Erro ao apagar (Versão 2):", err);
        return sock.sendMessage(from, { text: "❌ Erro ao tentar apagar a mensagem (V2)." }, { quoted: msg });
    }
}
break;
...
┃✜╏ *${config.prefix}placa*
┃➕
┃✜╏ *${config.prefix}placa2*
┃➕
┃✜╏ *${config.prefix}chassi*
┃➕
┃✜╏ *${config.prefix}cep*
┃➕
┃✜╏ *${config.prefix}cpf1*
...
┃✜╏ *${config.prefix}nome*
┃➕
┃✜╏ *${config.prefix}abreviado*
┃➕
┃✜╏ *${config.prefix}parentes*
┃➕
┃✜╏ *${config.prefix}mae*
┃➕ 
┃✜╏ *${config.prefix}pai*
...
┃✜╏ *${config.prefix}cnh*
┃➕
┃✜╏ *${config.prefix}socios*
┃➕
┃✜╏ *${config.prefix}funcionarios*
┃➕
┃✜╏ *${config.prefix}cnpj*
┃➕
┃✜╏ *${config.prefix}obito*
...
┃✜╏ *${config.prefix}pis*
┃➕
┃✜╏ *${config.prefix}vacinas*
┃➕
┃✜╏ *${config.prefix}empregos*
┃➕
┃✜╏ *${config.prefix}score*
┃➕
┃✜╏ *${config.prefix}ip*
...
┃╰━━━━━━━✦⚜✦━━━━━━━━╯
┃✛ ╏ ➕ *${config.prefix}ban*
┃✛ ╏ ➕ *${config.prefix}apagar*
┃✛ ╏ ➕ *${config.prefix}marcar*
┃✛ ╏ ➕ *${config.prefix}hidetag*
┃✛ ╏ ➕ *${config.prefix}hidetag2* 
┃✛ ╏ ➕ *${config.prefix}stats*
┃✛ ╏ ➕ *${config.prefix}fechargp* 
┃✛ ╏ ➕ *${config.prefix}backup* 
┃✛ ╏ ➕ *${config.prefix}antilinkhard* 
┃✛ ╏ ➕ *${config.prefix}antilinkgp* 
┃✛ ╏ ➕ *${config.prefix}welcome* 
┃╭━━━━━━━✦⚜✦━━━━━━━━╮
┃        ༺☾ *𝑴𝑬𝑵𝑼 +18* ☽༻
┃╰━━━━━━━✦⚜✦━━━━━━━━╯
┃✛ ╏ ➕ *${config.prefix}hentaihd*
┃✛ ╏ ➕ *${config.prefix}hentaihd2*
┃✛ ╏ ➕ *${config.prefix}xvideos*
┃✛ ╏ ➕ *${config.prefix}xnxx*
┃╭━━━━━━━✦⚜✦━━━━━━━━╮
┃      ༺☾ *𝑴𝑬𝑵𝑼 𝑩𝑨𝑺𝑰𝑪𝑶* ☽༻
┃╰━━━━━━━✦⚜✦━━━━━━━━╯
┃✛ ╏ ➕ *${config.prefix}attp*
┃✛ ╏ ➕ *${config.prefix}attp2*
┃✛ ╏ ➕ *${config.prefix}gerarnick*
┃✛ ╏ ➕ *${config.prefix}play*
┃✛ ╏ ➕ *${config.prefix}play2*
┃✛ ╏ ➕ *${config.prefix}play3*
┃✛ ╏ ➕ *${config.prefix}playvideo*
┃✛ ╏ ➕ *${config.prefix}playvideo2*
┃✛ ╏ ➕ *${config.prefix}playvideo3*
┃✛ ╏ ➕ *${config.prefix}tiktok*  
┃✛ ╏ ➕ *${config.prefix}youtube-mp4*
┃✛ ╏ ➕ *${config.prefix}youtube-mp3*
┃✛ ╏ ➕ *${config.prefix}instagram* 
┃✛ ╏ ➕ *${config.prefix}facebook*
┃✛ ╏ ➕ *${config.prefix}pinterest* 
┃✛ ╏ ➕ *${config.prefix}pinterest2* 
┃✛ ╏ ➕ *${config.prefix}wallpaper* 
┃✛ ╏ ➕ *${config.prefix}pinterestmp4* 
┃✛ ╏ ➕ *${config.prefix}imgpralink* 
┃✛ ╏ ➕ *${config.prefix}ia*
┃✛ ╏ ➕ *${config.prefix}flux* 
┃✛ ╏ ➕ *${config.prefix}sticker*
┃✛ ╏ ➕ *${config.prefix}toimg*
┃✛ ╏ ➕ *${config.prefix}perfil*
┃✛ ╏ ➕ *${config.prefix}testegay*
┃✛ ╏ ➕ *${config.prefix}ping* 
┃✛ ╏┄┄┄┄┄┄
┃✛ ╏ ✤ *número* : 21987765287
╰━━━━━━━━━━━━━━━━━━━━╯`;                                              
